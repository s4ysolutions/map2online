...
const wordings: Record<string, Record<string, Record<string, string>>> = {
  en: {
    ...
    'routes': {
      ...
      'Find in catalog': 'Show the route',
  ...
  ru: {
    ...
    'отрезки': {
      ...
      'Find in catalog': 'Показать отрезок',
    ...
    'маршруты': {
      ...
      'Find in catalog': 'Показать маршрут',
