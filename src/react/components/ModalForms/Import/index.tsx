...
import T from '../../../../l10n';
import FileUpload from '../../UIElements/FileUpload';
  ...
  return <Modal className="import-dialog" onClose={importUI.close} >
    <form onSubmit={cancelEvent} >
      ...
      <div className="import" >
        ...
        {inProgress ? <div className="upload-results" >
          <em >
          ...
          {mixProblem ? <div className="import-problem">
            <em >
          ...
          {flatProblem && !mixProblem ? <div className="import-problem">
            <em >
